...
Płytki oparte na ATmega (UNO, Nano, Mini, Mega) potrzebują około 100 mikrosekund (0,0001s) na odczyt wejścia analogowego, więc maksymalna szybkość odczutu wynosi około 10.000 razy na sekundę.
